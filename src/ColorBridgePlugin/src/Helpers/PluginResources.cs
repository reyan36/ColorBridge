namespace Loupedeck.ColorBridgePlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ColorBridgePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ColorBridgePlugin.Resources.Resource.txt`.
