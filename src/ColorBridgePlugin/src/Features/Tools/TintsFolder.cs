namespace Loupedeck.ColorBridgePlugin.Features.Tools
{
    ...
    public class TintsFolder : PluginDynamicFolder
    {
        ...
        public TintsFolder()
        {
            this.DisplayName = "Tints";
            this.Description = "Generate and show tint scale from current color";
        ...
        {
            this._engine.GenerateTints();
            PluginLog.Info("Generated tint scale");
        ...
        public override void RunCommand(String actionParameter)
        {
            ...
            if (ClipboardService.CopyToClipboard(colorString))
            {
                ...
                PluginLog.Info($"Selected + copied {colorString} from tint slot {slotNumber}");
            }
