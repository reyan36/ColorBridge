namespace Loupedeck.ColorBridgePlugin.Features.Palette
{
    ...
    public class PaletteFolder : PluginDynamicFolder
    {
        ...
        {
            if (!Int32.TryParse(actionParameter, out var slotNumber))
                return;
            ...
            if (palette == null || slotIndex >= palette.Length)
                return;
